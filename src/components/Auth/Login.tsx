      ...
      >
        <div className="flex flex-col items-center space-y-4">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-fg/40">Sign in to orchestrate your career</p>
          </div>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleLogin}>
          ...
          <div className="flex items-center justify-between px-2">
            <Link to="/forgot-password" className="text-[10px] font-bold uppercase tracking-widest text-fg/40 hover:text-accent transition-colors">
              Forgot Password?
            </Link>
            <Link to="/signup" className="text-[10px] font-bold uppercase tracking-widest text-accent hover:underline">
              Create Account
            </Link>
          </div>
